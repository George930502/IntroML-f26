...
- Team size: 4–6 students. Form your own team.
...
Propose your own novel idea and build it. Participation in AI challenges or competitions is also welcome.

### Investigation Track

Select an existing AI model or system and identify its limitations or flaws. Analyze when and why the model fails, then propose and evaluate potential solutions, or develop practical guidelines for using the model safely and effectively.
...
- Proposed approach (or, for the Investigation Track, the model to be investigated and the analysis plan)
- Expected results and evaluation plan
- Timetable and division of work
...
- Motivation and problem statement
- Changes since the proposal (if any)
